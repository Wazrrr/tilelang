...
def test_fmha_recommend_hints():
    ...
    # The attention template now includes normalization rather than modeling
    # two unrelated matrix multiplications with integer accumulation.
    run_fmha_recommend_hints(4, 32, 512, 512, 128, T.float16, T.float32, T.float16)
