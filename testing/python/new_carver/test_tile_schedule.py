...
from tilelang.new_carver.cta_work import collect_cta_work, estimate_grid_cycles
from tilelang.new_carver.reduction import fragment_reduction_work
from tilelang.new_carver.tile_schedule import buffer_transition, repeat_transition
...
def test_default_reference_has_a_pipeline_score():
    from examples.flash_attention.example_mha_new_carver import REFERENCE_CONFIG, get_configs
