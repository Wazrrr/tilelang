...
import torch
import tilelang
from tilelang.new_carver import analyze_prim_func, anchor_latency, profile_device, query_device_limits, rank_records
from tilelang.new_carver.config import ANALYSIS_VERSION
from tilelang.new_carver.device_profile import current_target
...
def main():
    ...
    parser.add_argument("--output", type=Path, default=Path("attention_carver.json"))
