...
from tilelang.new_carver import analyze_prim_func, anchor_latency, profile_device, rank_records
...
def main():
    ...
    parser.add_argument("--output", type=Path, default=Path("fp8_carver_report.json"))
    parser.add_argument(
    ...
    if args.validate_all:
        ...
        tuner = (
            ...
            .set_carver_args(True, **settings, report_path=str(args.output.with_suffix(".tuning.json")))
            .set_profile_args(
