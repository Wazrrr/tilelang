...
class TileTuneConfig:
    ...
    def __post_init__(self):
        ...
        if self.ranking_metric not in ("memory", "bound_aware", "rank_product", "work_max", "work_rank_product", "traffic_waves", "pipeline_time"):
            raise ValueError("ranking_metric must be memory, bound_aware, rank_product, work_max, work_rank_product, traffic_waves, or pipeline_time")
        ...
        if self.ranking_metric in ("memory", "bound_aware", "rank_product", "work_max", "work_rank_product") and (
