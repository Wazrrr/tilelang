...
from examples.gemm_fp8.example_gemm_fp8_new_carver import get_configs, make_gemm, TARGET
...
def main():
    ...
    if args.mode != "disabled":
        tuner.set_carver_args(
            True, mode=args.mode, report_path=str(args.output / "carver.json"), ranking_metric="pipeline_time", performance_model=profile
        )
