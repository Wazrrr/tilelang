"""Workload references and evaluation for the portable New Carver experiments.
...
from tilelang.new_carver import CarverConfig, rank_records
from tilelang.new_carver.cost import combine_tile_cost
from tilelang.new_carver.ranking import apply_ranking_metric
    ...
    for record in records:
        ...
        if "memory_traffic" in modules and "waves" in modules and "traffic_bytes_per_block" in modules["memory_traffic"]:
            ...
            result = apply_ranking_metric(
                ...
                modules["waves"],
                {},
                CarverConfig(ranking_metric="traffic_waves"),
