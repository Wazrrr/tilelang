"""FP8 GEMM holdouts with disjoint development and training shapes."""
...
def training_cases():
    ...
    return [
        Workload("gemm_fp8_" + split, "gemm_fp8", dict(m=m, n=n, k=k, transpose_b=True), dtype="float8_e4m3fn")
